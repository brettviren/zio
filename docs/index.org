...
described in the [[http://zguide.zeromq.org/][zguide]].  It also
provides a /ported graph/ model for constructing a network topology.
...
This package installs in the usual [[https://waf.io][Waf]] way.
