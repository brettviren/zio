...
- A [[file:task-broker.org][task broker]] implements a reliable service oriented task queue based on ZeroMQ majordomo design.

- Utility support to pack [[file:tensor.org][tensors]] into messages.
